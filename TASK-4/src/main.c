...
main (int argc, char *argv[])
{
  ...
  *buf = '\0';
  ...
  /* Находит конец буффера чтобы убрать лишние ,  после вывода.
   * Основная проблема в gnu extensions. Но я не считаю это проблемой
   * так как в условиях прописано использование gcc */
  buf[__fpending (stdout) - 2] = 0;
